...
function Order() {
  ...
  // useFetcher is a hook that allows us to make a request to the server
  const fetcher = useFetcher();
  // use fetcher to load the menu if it's not already loaded
  useEffect(function(){
  ...
  return (
    <div className="py-6 px-4 space-y-8">
      ...
      <ul className="divide-y divide-y border-b border-t ">
